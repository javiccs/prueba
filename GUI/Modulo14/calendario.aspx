<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="calendario.aspx.cs" Inherits="templateApp.GUI.Modulo14.calendario" %>
...
<body>
    ...
    <div>
        ...
        <asp:ImageButton ID="ImageButton1" runat="server" Height="16px" ImageUrl="~/dist/img/credit/visa.png" OnClick="ImageButton1_Click" />
